...
-- Parent ToggleButton to CoreGui
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Parent = game.CoreGui
ToggleButton.Parent = ScreenGui

-- Configure ToggleButton
ToggleButton.Name = "ONH"
...
ToggleButtonUIStroke.Color = Color3.fromRGB(255, 100, 0)
ToggleButtonUIStroke.Thickness = 2
ToggleButtonUIStroke.Transparency = 0.5
