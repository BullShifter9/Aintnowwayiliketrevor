...
function Library:CreateWindow(cfg)
    ...
    -- Window frame  (AnchorPoint centres it regardless of UIScale)
    local Win=New("Frame",{
        Name="Window",
    ...
    function Window:_AnimSel(btn)
        ...
        local h    = math.max(btn.AbsoluteSize.Y - 8, 16)
        local yPos = relY + 4   -- small offset to visually center on the button
        Tween(TabSel, TI_MED, {
