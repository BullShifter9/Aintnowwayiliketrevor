...
local function Draggable(handle, target)
    ...
    handle.InputBegan:Connect(function(i)
        ...
        or i.UserInputType == Enum.UserInputType.Touch then
            drag = true
            st   = i.Position
            -- Convert current visual position to pure pixel offsets.
            -- AbsolutePosition is the top-left corner; AnchorPoint shifts
            -- which point the Position property refers to, so we add
            -- AnchorPoint * AbsoluteSize to get the anchor's screen coords.
    ...
    function Window:AddTab(tabCfg)
        ...
        local function UpdateCanvas()
            Container.CanvasSize=UDim2.new(0,0,0,
                Container.UIListLayout.AbsoluteContentSize.Y+40)
        end
