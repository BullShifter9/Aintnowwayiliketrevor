...
-- Make the button draggable (works for both PC and mobile)
...
ToggleButton.MouseEnter:Connect(function()
    game:GetService("TweenService"):Create(UIStroke, TweenInfo.new(0.3), {Thickness = 3, Color = Color3.fromRGB(90, 90, 255)}):Play()
end)

ToggleButton.MouseLeave:Connect(function()
    game:GetService("TweenService"):Create(UIStroke, TweenInfo.new(0.3), {Thickness = 2, Color = Color3.fromRGB(60, 60, 255)}):Play()
end)

-- Initialize the toggle GUI with a bounce animation
ToggleButton.Size = UDim2.new(0, 0, 0, 0)
game:GetService("TweenService"):Create(ToggleButton, TweenInfo.new(0.5, Enum.EasingStyle.Bounce), {Size = UDim2.new(0, 50, 0, 50)}):Play()
