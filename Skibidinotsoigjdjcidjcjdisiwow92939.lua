...
-- Create an "Open" button that appears when UI is minimized
...
OpenButtonStroke.Color = Color3.fromRGB(60, 60, 255)
            ...
            if input.UserInputState == Enum.UserInputState.End then
                ...
                if (tick() - startTime < 0.3) and (input.Position - initialPosition).Magnitude < 5 then
                    ...
                    if not isMinimized then
                        ...
                        -- Animate the open button appearance
                        OpenButton.Size = UDim2.new(0, 0, 0, 40)
                        OpenButton.Position = UDim2.new(0.5, 0, 0.1, 0)
                        local openTween = game:GetService("TweenService"):Create(OpenButton, 
                            TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), 
                            {Size = UDim2.new(0, 120, 0, 40), Position = UDim2.new(0.5, -60, 0.1, 0)})
                        openTween:Play()
                    end
                end
            end
...
OpenButton.MouseButton1Click:Connect(function()
    Window:Minimize() -- This toggles minimized state in Fluent UI
    isMinimized = false
    
    -- Animate the open button disappearance
    local closeTween = game:GetService("TweenService"):Create(OpenButton, 
        TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), 
        {Size = UDim2.new(0, 0, 0, 40), Position = UDim2.new(0.5, 0, 0.1, 0)})
...
OpenButton.MouseEnter:Connect(function()
    game:GetService("TweenService"):Create(OpenButtonStroke, 
        TweenInfo.new(0.3), 
        {Thickness = 3, Color = Color3.fromRGB(90, 90, 255)}):Play()
end)
