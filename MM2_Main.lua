...
╠═══════════════════════════════════════════════════════╣
║  SETUP:                                               ║
║  1. Upload Mm2Ui.lua to your GitHub repo              ║
║  2. Replace MM2UI_URL below with your raw link:       ║
║     https://raw.githubusercontent.com/                ║
║         YourName/YourRepo/main/Mm2Ui.lua              ║
╚═══════════════════════════════════════════════════════╝
--]]

------------------------------------------------------------
-- 1.  LOAD THE GUI LIBRARY  (Mm2Ui — replaces OmniLib)
------------------------------------------------------------
...
STab:AddLabel("Powered by Mm2Ui — no external libs required.")
